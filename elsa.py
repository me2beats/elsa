...
# Сохраняем функции в отдельной переменной, чтобы они не затирались
функ_имена = ["напечатать_привет", "напечатать_пока", "создать_список", "добавить_функцию_в_список", "выполнить_список"]

def добавить_функцию_в_список(func_index, list_index):
    """Добавляет функцию в указанный список по индексу"""
    if 0 <= func_index < len(функ_имена) and 0 <= list_index < len(я['данные']):
        func_name = функ_имена[func_index]
